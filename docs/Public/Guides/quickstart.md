...
Product apps with one trusted frontend sizing surface can opt into one initial
fit or continuous meaningful content-fit updates on eligible Windows Edge or
Chrome webapp launches:
...
the [host-sizing guide](host-sizing.md) for the complete profile,
